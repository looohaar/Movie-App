                ...
                : Stack(
                    ...
                    children: [
                      ...
                      DownloadsImageWidget(
                        ...
                        imageList: "${baseUrl}${downloadsVariable.imageData!()?.results![0]}",
                      ...
                      DownloadsImageWidget(
                        size: Size(size.width * 0.4, size.width * 0.55),
                        imageList: "${baseUrl}${downloadsVariable.imageData!()?.results![1]}",
                      ...
                      DownloadsImageWidget(
                        ...
                        imageList: "${baseUrl}${downloadsVariable.imageData!()?.results![2]}",
